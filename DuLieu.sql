...
VALUES 
    (N'Nguyễn Văn An', '1985-06-15', 1, 2, 'T001'),
    (N'Lê Thị Bích', '1990-08-20', 0, 2, 'T001'),
    (N'Trần Văn Cường', '1975-11-05', 1, 2, 'T001'),
    (N'Phạm Thị Dung', '1988-02-13', 0, 2, 'T001'),

    (N'Đỗ Mạnh Hùng', '1992-03-22', 1, 3, 'T001'),
    (N'Vũ Minh Khánh', '1987-12-01', 1, 3, 'T001'),
    (N'Nguyễn Hương Lan', '1995-07-07', 0, 3, 'T001'),

    (N'Bùi Văn Mạnh', '1983-09-10', 1, 4, 'T003'),
    (N'Trương Ngọc Oanh', '1996-01-25', 0, 4, 'T003'),
    (N'Phan Văn Quý', '1989-04-30', 1, 4, 'T003'),
    (N'Hà Thị Mai', '1991-05-14', 0, 4, 'T003'),
    (N'Lê Trung Kiên', '1982-07-21', 1, 4, 'T003'),
    (N'Võ Văn Bình', '1993-03-18', 1, 4, 'T003'),
    (N'Phạm Minh Tuyết', '1997-08-29', 0, 4, 'T003'),
    (N'Đặng Thị Hồng', '1990-10-05', 0, 4, 'T003'),
    (N'Lương Văn Hùng', '1986-04-12', 1, 4, 'T003'),
    (N'Hoàng Ngọc Yến', '1994-09-30', 0, 4, 'T003'),

    (N'Nguyễn Thị Hoa', '1985-12-15', 0, 5, 'T004'),
    (N'Phạm Văn Dũng', '1990-02-20', 1, 5, 'T004'),
    (N'Lê Minh Khoa', '1981-11-25', 1, 5, 'T004'),
    (N'Nguyễn Thị Tâm', '1992-06-30', 0, 5, 'T004'),
    (N'Bùi Thế Anh', '1989-07-17', 1, 5, 'T004'),

    (N'Ngô Thị Lý', '1987-01-11', 0, 6, 'T005'),
    (N'Trần Công Danh', '1985-03-23', 1, 6, 'T005'),
    (N'Đỗ Hoàng Phúc', '1991-04-20', 1, 6, 'T005'),
    (N'Trần Thanh Hương', '1995-05-25', 0, 6, 'T005'),
    (N'Nguyễn Quốc Bảo', '1988-08-14', 1, 6, 'T005'),
    (N'Trịnh Thị Mai', '1993-09-29', 0, 6, 'T005');
